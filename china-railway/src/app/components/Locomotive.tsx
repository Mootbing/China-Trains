...
const Locomotive: React.FC<LocomotiveProps> = ({
  ...
  return (
    ...
    >
      ...
      {en_name && (
        <div className={`absolute inset-0 backdrop-blur-xs text-white opacity-0 ${infoHoverClasses} transition-opacity duration-200 flex flex-col items-center justify-center text-center p-2`} style={{ transform: 'scale(1)' }}>
